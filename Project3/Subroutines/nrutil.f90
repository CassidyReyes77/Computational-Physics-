MODULE nrutil
    USE nrtype
    IMPLICIT NONE
    INTEGER(kind=4), PARAMETER :: NPAR_ARTH=16,NPAR2_ARTH=8
    INTEGER(kind=4), PARAMETER :: NPAR_GEOP=4,NPAR2_GEOP=2
    INTEGER(kind=4), PARAMETER :: NPAR_CUMSUM=16
    INTEGER(kind=4), PARAMETER :: NPAR_CUMPROD=8
    INTEGER(kind=4), PARAMETER :: NPAR_POLY=8
    INTEGER(kind=4), PARAMETER :: NPAR_POLYTERM=8
    ...
    END INTERFACE
    INTERFACE imaxloc
        MODULE PROCEDURE imaxloc_r,imaxloc_i, imaxloc_d
    END INTERFACE
    INTERFACE assert
